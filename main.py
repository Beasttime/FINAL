...
def up():
    ...
    import signupmain
def about():
    showinfo("ABOUT-US","VERSION 1.0 MADE by G. SALIF informatics student at IvyTech school of IT for SEDV140 final project due on 10/12/2021 (PYTHON GUI app)")
def QU():
...
subm1.pack()
subm2=tk.Button(window1,text="ABOUT US",bg="lightblue",width=18,font=("times new roman",13),command=about)
subm2.pack()
subm3=tk.Button(window1,text="SHOPS-BAGS",bg="lightblue",width=18,font=("times new roman",13),command=sb)
subm3.pack()
subm4=tk.Button(window1,text="SHOP-ACCESSORIES",bg="lightblue",width=18,font=("times new roman",13),command=sa)
subm4.pack()
